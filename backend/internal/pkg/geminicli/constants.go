...
const (
	...
	// Public evaluation snapshots do not embed the built-in Gemini CLI OAuth credentials.
	// Provide them via environment variables when you need the built-in OAuth flow.
	GeminiCLIOAuthClientID     = "builtin-gemini-cli-client-id-via-env"
	GeminiCLIOAuthClientSecret = "builtin-gemini-cli-client-secret-via-env"

	// GeminiCLIOAuthClientIDEnv / GeminiCLIOAuthClientSecretEnv are the environment
	// variable names for the built-in Gemini CLI client credentials.
