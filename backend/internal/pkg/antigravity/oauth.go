...
const (
	...
	// Antigravity OAuth built-in client credentials are redacted in public snapshots.
	ClientID = "builtin-antigravity-client-id-via-env"

	// AntigravityOAuthClientIDEnv / AntigravityOAuthClientSecretEnv are the env variable names
	// for the built-in Antigravity OAuth client credentials.
...
// defaultClientID/defaultClientSecret 可通过环境变量覆盖 public snapshot placeholders.
var defaultClientID = ClientID
var defaultClientSecret = "builtin-antigravity-client-secret-via-env"
